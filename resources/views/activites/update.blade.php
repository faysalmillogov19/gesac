...
<div class="modal-content">
            ...
            <form class="modal-body" method="POST" action="{{route('activite.store')}}">
                @csrf
                ...
                @if($row->id)<input type="hidden" name='id' value="{{$row->id}}" required>@endif
                  ...
                  <div class="form-group">
                    ...
                    @if( $row->code ) value="{{$row->code}}" @endif required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="description" placeholder="Description" required>@if($row->libelle) {{$row->libelle}} @endif</textarea>
                  </div>
