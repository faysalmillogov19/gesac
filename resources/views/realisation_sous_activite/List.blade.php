@extends('layout.dashroad')
 @section("content")
    ...
    <section class="content center">
	 ...
	 @endif
      <div class="row">
        @include('realisation_sous_activite.add')
        <div class="col-4">
          <ul class="list-group">
        ...
        <div class="col-8">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Réalisations sous activité</h3>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  @include('realisation_sous_activite.update')
                  @include('realisation_sous_activite.delete')
                @endforeach
                </tbody>
