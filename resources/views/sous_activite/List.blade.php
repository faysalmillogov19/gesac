      ...
      <div class="row">
        ...
        <div class="col-4">
          <ul class="list-group">
            ...
            <li class="list-group-item"> @if($var['plan']->affectation_produit) <a type="button" href="{{route('affectation_activite.show',$var['plan']->affectation_produit)}}" class="btn btn-ligth text-info"><i class="fas fa-arrow-alt-circle-left"></i> Revenir aux activités </a> @endif</li>
          </ul>
        </div>
        <div class="col-8">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Sous Activté</h3>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                        <a href="{{route('periode_sous_activite.show',$row->id)}}" data-toggle="tooltip" data-placement="top" title="Périodes" class="btn btn-secondary btn-sm" ><i class="nav-icon fa fa-calendar"></i></a>
                        <a href="{{route('financement_sous_activite.show',$row->id)}}" data-toggle="tooltip" data-placement="top" title="Financements" class="btn btn-warning btn-sm" ><i class="nav-icon fas fa-coins"></i></a>
                        ...
                        <button type="button"  class="btn btn-danger btn-sm" data-toggle="modal" data-target="#supprimer{{$row->id}}"> <i class="nav-icon fa fa-trash"></i></button>
				          ...
				          @include('sous_activite.update')
                  @include('sous_activite.delete')
                @endforeach
                </tbody>
